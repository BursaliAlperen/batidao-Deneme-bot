...
const DEFAULT_PTC_TARGET_URL = 'https://zerads.com/ptc?ref=10799';
const RAW_PTC_TARGET_URL = process.env.ZERADS_PTC_TARGET_URL || DEFAULT_PTC_TARGET_URL;
const ZERADS_PTC_TARGET_URL = String(RAW_PTC_TARGET_URL).includes('/zerads-callback') ? DEFAULT_PTC_TARGET_URL : RAW_PTC_TARGET_URL;
